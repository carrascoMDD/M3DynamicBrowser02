...
public class M3ReplicateNodeMgr_replicatedMetaType_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3ReplicateNodeMgr_replicatedMetaType_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3ReplicateNodeMgr_replicatedMetaType_remove anAction =
      new M3ReplicateNodeMgr_replicatedMetaType_remove(
        getTargetNode());
