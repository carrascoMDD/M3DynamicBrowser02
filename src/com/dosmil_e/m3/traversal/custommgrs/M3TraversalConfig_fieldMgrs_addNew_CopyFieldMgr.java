...
public class M3TraversalConfig_fieldMgrs_addNew_CopyFieldMgr extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public M3TraversalConfig_fieldMgrs_addNew_CopyFieldMgr(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3TraversalConfig_fieldMgrs_addNew_CopyFieldMgr anAction =
      new M3TraversalConfig_fieldMgrs_addNew_CopyFieldMgr( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createCopyFieldMgr.gif");
  }
