...
public class M3TraversalConfig_branchMgrs_addNew_ReplicateBranchMgr extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public M3TraversalConfig_branchMgrs_addNew_ReplicateBranchMgr(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3TraversalConfig_branchMgrs_addNew_ReplicateBranchMgr anAction =
      new M3TraversalConfig_branchMgrs_addNew_ReplicateBranchMgr( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createReplicateBranchMgr.gif");
  }
