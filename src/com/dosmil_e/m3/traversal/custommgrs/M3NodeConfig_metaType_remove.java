...
public class M3NodeConfig_metaType_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3NodeConfig_metaType_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3NodeConfig_metaType_remove anAction =
      new M3NodeConfig_metaType_remove(
        getTargetNode());
