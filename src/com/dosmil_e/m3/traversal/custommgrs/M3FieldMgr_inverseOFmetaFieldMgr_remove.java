...
public class M3FieldMgr_inverseOFmetaFieldMgr_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3FieldMgr_inverseOFmetaFieldMgr_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3FieldMgr_inverseOFmetaFieldMgr_remove anAction =
      new M3FieldMgr_inverseOFmetaFieldMgr_remove(
        getTargetNode());
