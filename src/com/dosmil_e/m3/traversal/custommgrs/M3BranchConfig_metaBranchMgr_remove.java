...
public class M3BranchConfig_metaBranchMgr_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3BranchConfig_metaBranchMgr_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3BranchConfig_metaBranchMgr_remove anAction =
      new M3BranchConfig_metaBranchMgr_remove(
        getTargetNode());
