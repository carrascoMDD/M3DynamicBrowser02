...
public class M3TypeNodeConfig_metaType_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3TypeNodeConfig_metaType_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3TypeNodeConfig_metaType_remove anAction =
      new M3TypeNodeConfig_metaType_remove(
        getTargetNode());
