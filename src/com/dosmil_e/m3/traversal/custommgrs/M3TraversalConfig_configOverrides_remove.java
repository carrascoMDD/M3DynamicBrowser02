...
public class M3TraversalConfig_configOverrides_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3TraversalConfig_configOverrides_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3TraversalConfig_configOverrides_remove anAction =
      new M3TraversalConfig_configOverrides_remove(
        getTargetNode());
