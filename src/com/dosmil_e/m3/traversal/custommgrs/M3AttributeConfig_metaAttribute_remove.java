...
public class M3AttributeConfig_metaAttribute_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3AttributeConfig_metaAttribute_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3AttributeConfig_metaAttribute_remove anAction =
      new M3AttributeConfig_metaAttribute_remove(
        getTargetNode());
