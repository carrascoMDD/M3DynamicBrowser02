...
public class M3NodeConfig_metaNodeMgr_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3NodeConfig_metaNodeMgr_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3NodeConfig_metaNodeMgr_remove anAction =
      new M3NodeConfig_metaNodeMgr_remove(
        getTargetNode());
