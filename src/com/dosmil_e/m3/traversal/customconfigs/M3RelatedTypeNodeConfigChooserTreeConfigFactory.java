...
public class M3RelatedTypeNodeConfigChooserTreeConfigFactory {

  public static EAIConfig     gConfig;
  public static Class         gCtxtClass;

  public M3RelatedTypeNodeConfigChooserTreeConfigFactory() {
  }
  ...
  public static EAIConfig initConfig( EAIMMCtxtIfc theCtxt) {
    ...
    EAIClassChooserFilterConfigIfc anOfClassChooserConfig = new EAIClassChooserFilterConfig(
      theCtxt.getMMFactory("M3").getClassForType( theCtxt, "RelatedTypeNodeConfig", "traversal"),
      new EAIOfClassChooserFilter( theCtxt.getMMFactory("M3").getClassForType( theCtxt, "RelatedTypeNodeConfig", "traversal")));
