...
public class M3NodeConfigChooserTreeConfigFactory {

  public static EAIConfig     gConfig;
  public static Class         gCtxtClass;

  public M3NodeConfigChooserTreeConfigFactory() {
  }
  ...
  public static EAIConfig initConfig( EAIMMCtxtIfc theCtxt) {
    ...
    EAIClassChooserFilterConfigIfc anOfClassChooserConfig = new EAIClassChooserFilterConfig(
      theCtxt.getMMFactory("M3").getClassForType( theCtxt, "NodeConfig", "traversal"),
      new EAIOfClassChooserFilter( theCtxt.getMMFactory("M3").getClassForType( theCtxt, "NodeConfig", "traversal")));
