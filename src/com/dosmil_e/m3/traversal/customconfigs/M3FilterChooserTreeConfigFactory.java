...
public class M3FilterChooserTreeConfigFactory {

  public static EAIConfig     gConfig;
  public static Class         gCtxtClass;

  public M3FilterChooserTreeConfigFactory() {
  }
  ...
  public static EAIConfig initConfig( EAIMMCtxtIfc theCtxt) {
    ...
    EAIClassChooserFilterConfigIfc anOfClassChooserConfig = new EAIClassChooserFilterConfig(
      theCtxt.getMMFactory("M3").getClassForType( theCtxt, "Filter", "traversal"),
      new EAIOfClassChooserFilter( theCtxt.getMMFactory("M3").getClassForType( theCtxt, "Filter", "traversal")));
