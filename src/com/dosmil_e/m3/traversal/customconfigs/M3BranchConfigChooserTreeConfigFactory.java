...
public class M3BranchConfigChooserTreeConfigFactory {

  public static EAIConfig     gConfig;
  public static Class         gCtxtClass;

  public M3BranchConfigChooserTreeConfigFactory() {
  }
  ...
  public static EAIConfig initConfig( EAIMMCtxtIfc theCtxt) {
    ...
    EAIClassChooserFilterConfigIfc anOfClassChooserConfig = new EAIClassChooserFilterConfig(
      theCtxt.getMMFactory("M3").getClassForType( theCtxt, "BranchConfig", "traversal"),
      new EAIOfClassChooserFilter( theCtxt.getMMFactory("M3").getClassForType( theCtxt, "BranchConfig", "traversal")));
