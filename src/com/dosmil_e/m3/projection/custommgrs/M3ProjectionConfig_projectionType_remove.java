...
public class M3ProjectionConfig_projectionType_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3ProjectionConfig_projectionType_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3ProjectionConfig_projectionType_remove anAction =
      new M3ProjectionConfig_projectionType_remove(
        getTargetNode());
