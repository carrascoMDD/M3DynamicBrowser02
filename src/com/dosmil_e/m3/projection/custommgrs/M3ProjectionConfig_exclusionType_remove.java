...
public class M3ProjectionConfig_exclusionType_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3ProjectionConfig_exclusionType_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3ProjectionConfig_exclusionType_remove anAction =
      new M3ProjectionConfig_exclusionType_remove(
        getTargetNode());
