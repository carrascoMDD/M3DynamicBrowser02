...
public class M3RelatedTypeNodeConfig_nodeConfig_branchConfigsBMgr extends EAIBranchMgr {


  public M3RelatedTypeNodeConfig_nodeConfig_branchConfigsBMgr() {
    super( );
  }
    ...
    protected EAIMMElementIfc[] getNodeConfigBranchConfigs( EAITreeNode theNode) {
      ...
      try { aNodeConfig = (com.dosmil_e.m3.traversal.ifc.M3NodeConfigIfc) aRelatedTypeNodeConfig.getNodeConfig( aCtxt); }
        ...
        if( someM3Relationships != null) {
          ...
          for( int anIndex = 0; anIndex < aNumRelationships; anIndex++) {
            ...
            if( aRelationship != null) {
              EAIActionIfc anAction = new EAIAction_RelatedTypeNodeConfig_NodeConfig_addNew_branchConfigs_ForRelationship(
