...
public class EAIAction_RelatedTypeNodeConfig_NodeConfig_addNew_branchConfigs_ForRelationship extends EAIRebindableAction {

  protected com.dosmil_e.m3.core.ifc.M3RelationshipIfc       vM3RelationshipForNewBranch;

  public EAIActionIfc cloneBase() throws CloneNotSupportedException {

    EAIAction_RelatedTypeNodeConfig_NodeConfig_addNew_branchConfigs_ForRelationship anAction =
      new EAIAction_RelatedTypeNodeConfig_NodeConfig_addNew_branchConfigs_ForRelationship( vTargetNode, vM3RelationshipForNewBranch);
  ...
  public EAIAction_RelatedTypeNodeConfig_NodeConfig_addNew_branchConfigs_ForRelationship(
    EAITreeNode                         theNode,
  ...
  public void actionPerformed( ActionEvent theEvent) {
    ...
    try {
      ...
      aNodeConfig = aRelatedTypeNodeConfig.getNodeConfig( aCtxt);
