...
public class M3MMElementHorizontalEditorPanel extends EAIEditorPanel implements DocumentListener, EAIRootChangeListenerIfc {
  ...
  public M3MMElementHorizontalEditorPanel() {
    try  {
      jbInit();
    }
    catch(Exception ex) {
