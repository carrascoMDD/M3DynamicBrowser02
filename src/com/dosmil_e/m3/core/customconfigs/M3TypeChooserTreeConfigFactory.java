...
public class M3TypeChooserTreeConfigFactory {

  public static EAIConfig     gConfig;
  public static Class         gCtxtClass;

  public M3TypeChooserTreeConfigFactory() {
  }
  ...
  public static EAIConfig initConfig( EAIMMCtxtIfc theCtxt) {
    ...
    EAIClassChooserFilterConfigIfc anOfClassChooserConfig = new EAIClassChooserFilterConfig(
      theCtxt.getMMFactory("M3").getClassForType( theCtxt, "Type", "core"),
      new EAIOfClassChooserFilter( theCtxt.getMMFactory("M3").getClassForType( theCtxt, "Type", "core")));
