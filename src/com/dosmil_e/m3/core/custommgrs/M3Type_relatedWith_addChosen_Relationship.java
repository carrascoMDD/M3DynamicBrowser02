...
public class M3Type_relatedWith_addChosen_Relationship extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public M3Type_relatedWith_addChosen_Relationship(
    ...
    super( theNode,
      ...
      com.dosmil_e.m3.core.meta.M3TypeMeta.getStaticM3Type( theNode.getMMCtxt()) == null
        ? null : com.dosmil_e.m3.core.meta.M3TypeMeta.vm3RelRelatedWith,
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3Type_relatedWith_addChosen_Relationship anAction =
      new M3Type_relatedWith_addChosen_Relationship(
      getTargetNode());
