...
public class M3Type_inverseOFprojectionType_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3Type_inverseOFprojectionType_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3Type_inverseOFprojectionType_remove anAction =
      new M3Type_inverseOFprojectionType_remove(
        getTargetNode());
