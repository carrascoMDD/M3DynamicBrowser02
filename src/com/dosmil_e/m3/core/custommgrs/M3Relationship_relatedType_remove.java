...
public class M3Relationship_relatedType_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3Relationship_relatedType_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3Relationship_relatedType_remove anAction =
      new M3Relationship_relatedType_remove(
        getTargetNode());
