...
public class M3Type_rootTypeOfModel_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3Type_rootTypeOfModel_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3Type_rootTypeOfModel_remove anAction =
      new M3Type_rootTypeOfModel_remove(
        getTargetNode());
