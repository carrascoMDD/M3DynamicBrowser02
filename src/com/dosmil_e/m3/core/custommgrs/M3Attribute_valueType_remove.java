...
public class M3Attribute_valueType_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3Attribute_valueType_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3Attribute_valueType_remove anAction =
      new M3Attribute_valueType_remove(
        getTargetNode());
