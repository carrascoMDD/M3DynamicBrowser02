...
public class M3Relationship_inverseOFreplicatedMetaRelationship_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3Relationship_inverseOFreplicatedMetaRelationship_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3Relationship_inverseOFreplicatedMetaRelationship_remove anAction =
      new M3Relationship_inverseOFreplicatedMetaRelationship_remove(
        getTargetNode());
