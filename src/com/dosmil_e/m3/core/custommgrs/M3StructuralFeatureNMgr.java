...
import com.dosmil_e.m3.core.ifc.M3StructuralFeatureIfc;


public class M3StructuralFeatureNMgr extends EAINodeMgr {


  public M3StructuralFeatureNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/StructuralFeature.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          M3StructuralFeature_delete.class
        }
      )
    };
  }
