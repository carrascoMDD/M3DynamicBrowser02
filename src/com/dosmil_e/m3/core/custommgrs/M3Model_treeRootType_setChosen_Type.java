...
public class M3Model_treeRootType_setChosen_Type extends
  com.dosmil_e.browserbase.metamgrs.EAISetChosenAction {


  public M3Model_treeRootType_setChosen_Type(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3Model_treeRootType_setChosen_Type anAction =
      new M3Model_treeRootType_setChosen_Type(
      getTargetNode());
