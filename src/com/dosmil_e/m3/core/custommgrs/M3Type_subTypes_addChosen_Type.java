...
public class M3Type_subTypes_addChosen_Type extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public M3Type_subTypes_addChosen_Type(
    ...
    super( theNode,
      ...
      com.dosmil_e.m3.core.meta.M3TypeMeta.getStaticM3Type( theNode.getMMCtxt()) == null
        ? null : com.dosmil_e.m3.core.meta.M3TypeMeta.vm3RelSubTypes,
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3Type_subTypes_addChosen_Type anAction =
      new M3Type_subTypes_addChosen_Type(
      getTargetNode());
