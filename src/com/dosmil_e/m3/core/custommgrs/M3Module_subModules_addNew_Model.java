...
public class M3Module_subModules_addNew_Model extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public M3Module_subModules_addNew_Model(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3Module_subModules_addNew_Model anAction =
      new M3Module_subModules_addNew_Model( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createModel.gif");
  }
