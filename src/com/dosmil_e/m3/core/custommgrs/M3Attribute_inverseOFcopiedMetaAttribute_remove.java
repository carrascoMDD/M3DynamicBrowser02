...
public class M3Attribute_inverseOFcopiedMetaAttribute_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3Attribute_inverseOFcopiedMetaAttribute_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3Attribute_inverseOFcopiedMetaAttribute_remove anAction =
      new M3Attribute_inverseOFcopiedMetaAttribute_remove(
        getTargetNode());
