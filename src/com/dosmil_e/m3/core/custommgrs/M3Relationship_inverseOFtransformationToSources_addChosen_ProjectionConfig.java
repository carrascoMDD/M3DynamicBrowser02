...
public class M3Relationship_inverseOFtransformationToSources_addChosen_ProjectionConfig extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public M3Relationship_inverseOFtransformationToSources_addChosen_ProjectionConfig(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3Relationship_inverseOFtransformationToSources_addChosen_ProjectionConfig anAction =
      new M3Relationship_inverseOFtransformationToSources_addChosen_ProjectionConfig(
      getTargetNode());
