...
public class M3Type_inverseOFreplicatedMetaType_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public M3Type_inverseOFreplicatedMetaType_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    M3Type_inverseOFreplicatedMetaType_remove anAction =
      new M3Type_inverseOFreplicatedMetaType_remove(
        getTargetNode());
